...
use MathParser\Parsing\Nodes\{ConstantNode, ExpressionNode, FunctionNode, IntegerNode, NumberNode, RationalNode, SubExpressionNode, VariableNode};
...
class NodeTest extends TestCase {
	...
	public function testCanComputeComplexity() {
		...
		$node = new SubExpressionNode('(');
		$this->assertEquals($node->complexity(), 1_000);
	}
