...
use MathParser\Parsing\Nodes\{ConstantNode, IntegerNode, VariableNode};
...
class LaTeXPrinterTest extends TestCase {
	...
	/** @test */
	public function itCanPrintExponentialFunctions(): void {
	...
	/** @test */
	public function itCanPrintPowers(): void {
		$this->assertResult('x^y', 'x^y');
